...
4. In gamemode and all filterscripts after #include <a_samp> write the following: #include <nex-ac>     Warning! If you are using a Streamer Plugin by Incognito, include it before nex-ac!
