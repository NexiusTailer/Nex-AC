[Download latest release (v1.9.29)](https://github.com/NexiusTailer/Nex-AC/tree/master/src/v1.9/v1.9.29)
...
***Warning! If you use Streamer Plugin by Incognito, Timerfix, foreach or y_hooks, include it before nex-ac!***  
