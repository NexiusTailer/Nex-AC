...
4.1. If you want to use custom .lang file, in gamemode after *#include <a_samp>* write the following:
```
#define DEBUG
#include <nex-ac_ru.lang> //or any other
#include <nex-ac>
```
4.2 Otherwise, in gamemode after *#include <a_samp>* write the following:
```
#include <nex-ac>
```
